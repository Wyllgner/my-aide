...
from aide.storage.search import indexar, remover_do_indice
...
def create(ctx: ToolContext, title: str, body: str, tags: str | None = None,
    ...
    indexar(ctx.conn, cur.lastrowid, title, body)
...
def append(ctx: ToolContext, body: str, id: int | None = None,
    ...
    indexar(ctx.conn, row["id"], row["title"], vault.corpo_de(caminho))
